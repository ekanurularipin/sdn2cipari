...
?>
	...
	?>
		...
		<center>
			<h2 class="page-header">FORMULIR PENDAFTARAN SISWA BARU 2024</h2>
		</center>
			...
			<div class="nav-tabs-custom">
				<div class="tab-content">
					<div class="tab-pane active" id="tab_1">
						...
						<center>
							<h5>(Kolom bertanda (*) Wajib Diisi)</h5>
						</center><br>
					...
					<div class="tab-pane" id="tab_2">
						<h3 class="page-header">B. Riwayat Pendidikan Siswa</h3>
						<div class="form-group">
							<label for="namasekolah" class="col-sm-3 control-label">Nama Sekolah Asal</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" autocomplete="off" id="namasekolah" onkeyup="this.value = this.value.toUpperCase()" name="namasekolah" placeholder="Nama PAUD/TKA bila bersekolah" required />
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
							<label for="alamatsekolah" class="col-sm-3 control-label">No. induk siswa atau NISN</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" autocomplete="off" id="alamatsekolah" onkeyup="this.value = this.value.toUpperCase()" name="alamatsekolah" placeholder="No. nisn bila ada" required /> Ex: 2-13-02-24-011-012-5 (Biasanya terdapat di Surat Kelulusan / ijazah)
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
							<label for="nisn" class="col-sm-3 control-label">Nomor KIP/KIS/PKH (Jika Ada)</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" autocomplete="off" id="nisn" onkeyup="this.value = this.value.toUpperCase()" name="nisn" placeholder="Boleh di Kosongkan">
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-5">
								<a href="#tab_1" data-toggle="tab" class="btn btn-success">SEBELUMNYA</a>
								<a href="#tab_3" data-toggle="tab" class="btn btn-primary">SELANJUTNYA</a> <br /><small><i></i></small>
							</div>
						</div> <!-- /.form-group -->
					</div><!-- /.tab-pane -->
					...
					<div class="tab-pane" id="tab_3">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="jabatanayah" onkeyup="this.value = this.value.toUpperCase()" name="jabatanayah" placeholder="Jabatan dalam Pekerjaan (Boleh di Kosongkan)">
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
					...
					<div class="tab-pane" id="tab_4">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="jabatanibu" onkeyup="this.value = this.value.toUpperCase()" name="jabatanibu" placeholder="Jabatan dalam Pekerjaan (Boleh di Kosongkan)">
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
					...
					<div class="tab-pane" id="tab_5">
						...
						<center>
							<h4>(KOSONGKAN JIKA ORANTUA (AYAH) MASIH DIDUP)</h4>
						</center><br>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="jabatanwali" onkeyup="this.value = this.value.toUpperCase()" name="jabatanwali" placeholder="Jabatan dalam pekerjaan ( boleh kosong )" />
							</div>
						</div> <!-- /.form-group -->
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-5">
								...
								<button onclick="popup()" type="submit" class="btn btn-warning" id="daftar" name="daftar" value="DAFTAR SEKARANG">DAFTAR SEKARANG</button>
								<script>
									function popup() {
										swal("Harap Isi pendaftaran", "Dengan Benar", "warning");
									}
								</script>
							</div>
						</div> <!-- /.form-group -->
...
elseif ($module == "input-pendaftaran") {
	...
	?>
			<h2 class="page-header">FORMULIR PENDAFTARAN SISWA BARU SD NEGERI 2 CIPARI</h2>
			<div class="callout callout-info">
				...
				<p><a class="btn btn-success btn-xs" href="pengumuman.html" target="_blank" alt="PDF File" title="PDF File"></i>BUKTI PENDAFTARAN</a> &nbsp;</p>
			</div>
		<?php
		} else {
		?>
...
elseif ($module == 'pengumuman') {
	...
	?>
		<div class="box box-success" <?php echo $myData['id_siswa']; ?> style="border-top-color: #ffd310;">
			...
			<div class="box-body">
				<table id="pengumumanditerima" class="table table-bordered table-striped">
					...
					<tbody>
						...
						?>
							<tr>
								<td <?php echo $t['id_siswa']; ?>>
									<?php echo $t['id_siswa']; ?></td>
								<td><?php echo $t['nm_siswa']; ?></td>
								<td><?php echo $t['tgl_lahir']; ?></td>
								<td><?php echo $t['nm_sekolah']; ?></td>
								<td><?php echo $t['status']; ?></td>
								<td class="text-center">
									<a class="btn btn-success btn-xs" href="cetak.php?id=<?php echo $t['id_siswa']; ?>" target="_blank" alt="PDF File" title="PDF File"><i class="fa fa-file-pdf-o"></i></a> &nbsp;
		...
		<div class="box box-danger">
			<div class="box-header with-border">
				<h3 class="box-title"><b>PESERTA DITOLAK</b></h3>
			</div>
			<div class="box-body">
				<table id="pengumumanditolak" class="table table-bordered table-striped">
					<thead>
						<tr>
							<th>ID</th>
							<th>NAMA</th>
					...
					<tbody>
						<?php
						$ditolak = mysqli_query($colok, "SELECT * FROM siswa WHERE status='DITOLAK' ORDER BY id_siswa");
						while ($k   = mysqli_fetch_array($ditolak)) {
						?>
							<tr>
								<td><?php echo $k['id_siswa']; ?></td>
								<td><?php echo $k['nm_siswa']; ?></td>
								<td><?php echo $k['tgl_lahir']; ?></td>
								<td><?php echo $k['nm_sekolah']; ?></td>
								<td><?php echo $k['status']; ?></td>
								<td class="text-center">
									<a class="btn btn-success btn-xs" href="cetak.php?id=<?php echo $k['id_siswa']; ?>" target="_blank" alt="PDF File" title="PDF File"><i class="fa fa-file-pdf-o"></i></a> &nbsp;
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-success btn-xs" href="cetak.php?id=<?php echo $c['id_siswa']; ?>" target="_blank" alt="PDF File" title="PDF File"><i class="fa fa-file-pdf-o"></i></a> &nbsp;
		...
		<div class="box box-yellow">
			<div class="box-header with-border">
				<h3 class="box-title"><b>PESERTA DAFTAR</b></h3>
			</div>
			<div class="box-body">
				<table id="pengumumandaftar" class="table table-bordered table-striped">
					<thead>
						<tr>
							<th>ID</th>
							<th>NAMA</th>
					...
					<tbody>
						<?php
						$cadangan = mysqli_query($colok, "SELECT * FROM siswa  WHERE status='DAFTAR' ORDER BY id_siswa");
						while ($c   = mysqli_fetch_array($cadangan)) {
						?>
							<tr>
								<td><?php echo $c['id_siswa']; ?></td>
