...
<head>
  ...
  <meta name="author" content="Admin SDN 2 CIPARI">
  <meta property="og:image" content="" />
  <meta name="language" content="Indonesia">
  <meta name="robots" content="index, follow">
  <meta name="description" content="Selamat Datang di Halaman SPMB Online SDN 2 CIPARI, anda akan dimudahkan dalam melakukan pendaftaran ke SDN 2 CIPARI tanpa harus mengisi Formulir lansung di Sekretariat Pendaftaran.">
  <meta name="keywords" content="SPMB Online 2025, SPMB SDN 2 CIPARI 2025, Daftar Online, SPMB ONLINE SDN 2 CIPARI, Indonesia, Sekolah">
  <meta property="og:image" content="http://indowarta.com/wp-content/uploads/2017/06/PPDB-Online.pdf">
  <title>SPMB ONLINE | <?php echo $d['nama_sekolah']; ?></title>
...
<body class="hold-transition skin-green layout-top-nav">
  <div class="wrapper">
    <header class="main-header">
      <nav class="navbar navbar-static-top" style="background-color: #001975;">
        <div class="container">
          <div class="navbar-header">
            <a href="<?php echo $d['alamat_website']; ?>" class="navbar-brand"><b>SPMB ONLINE</b></a>
    ...
    <footer class="main-footer">
      <div class="container">
        <strong>Pendaftaran Peserta Didik Online <?php echo $d['nama_sekolah']; ?> | Repost by <a href="https://www.instagram.com/rifakhnsa_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">rifa</a></strong>
      </div><!-- /.container -->
    </footer>
  </div><!-- ./wrapper -->
  ...
  <script>
    $(function() {
      ...
      $('#tgllahirayah').daterangepicker({
        singleDatePicker: true,
        format: 'DD-MM-YYYY',
        "opens": "right"
      });
      $('#tgllahiribu').daterangepicker({
        singleDatePicker: true,
        format: 'DD-MM-YYYY',
        "opens": "right"
      });
      $('#tgllahirwali').daterangepicker({
        singleDatePicker: true,
        format: 'DD-MM-YYYY',
        "opens": "right"
      });
      ...
      $('#pengumumanditolak').DataTable();
      $('#pengumumandaftar').DataTable();
    });
  </script>
</body>
